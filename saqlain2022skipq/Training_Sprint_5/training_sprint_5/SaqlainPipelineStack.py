...
from training_sprint_5.SaqlainStage import SaqlainStage
...
class SaqlainPipelineStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        pipeline.add_stage(prod,pre=[pipelines.ManualApprovalStep("Ready_For_Production")])
